...
python scripts/48-evaluate_harnesslm_beir.py --datasets all --query_model_name /data/outputs/reform/alignment/02-Alignment_1024/01-Alignment_Qwen3-Embedding-0.6B_pruned_50_no_prompt_to_0.6B_HF/ --query_model_type qwen --doc_model_name Qwen/Qwen3-Embedding-0.6B --doc_model_type qwen --batch_size 256 --use_data_parallel --metric_dir /data/outputs/reform/alignment/02-Alignment_1024/01-Alignment_Qwen3-Embedding-0.6B_pruned_50_no_prompt_to_0.6B_HF/ --query_prefix "" --embeddings_dir /data/outputs//benchmarks/04-qwen_embedding_0.6B/corpus_embeddings/

python scripts/48-evaluate_harnesslm_beir.py --datasets all --query_model_name /data/suchith/outputs/reform/alignment/02-Alignment_1024/03-Alignment_Qwen3-Embedding-0.6B_pruned_50_ffn_null_no_prompt_to_0.6B_HF/ --query_model_type qwen --doc_model_name Qwen/Qwen3-Embedding-0.6B --doc_model_type qwen --batch_size 256 --use_data_parallel --metric_dir /data/suchith/outputs/reform/alignment/02-Alignment_1024/03-Alignment_Qwen3-Embedding-0.6B_pruned_50_ffn_null_no_prompt_to_0.6B_HF/ --query_prefix "" --embeddings_dir /data/outputs//benchmarks/04-qwen_embedding_0.6B/corpus_embeddings/

python scripts/48-evaluate_harnesslm_beir.py --datasets all --query_model_name /data/scratch/suchith/alignment/02-Alignment_1024/02-Alignment_Qwen3-Embedding-0.6B_pruned_50_pruned_50_no_prompt_to_0.6B_HF/ --query_model_type qwen --doc_model_name Qwen/Qwen3-Embedding-0.6B --doc_model_type qwen --batch_size 256 --use_data_parallel --metric_dir /data/scratch/suchith/alignment/02-Alignment_1024/02-Alignment_Qwen3-Embedding-0.6B_pruned_50_pruned_50_no_prompt_to_0.6B_HF/ --query_prefix "" --embeddings_dir /data/outputs//benchmarks/04-qwen_embedding_0.6B/corpus_embeddings/
