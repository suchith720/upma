...
if __name__ == '__main__':
    ...
    output_dir = "/home/aiscuser/scratch1/outputs/upma/09_upma-with-ngame-gpt-intent-substring-linker-for-msmarco-003"
    ...
    if input_args.beir_mode:
        ...
        upma_beir_inference(output_dir, input_args, mname, "msmarco-intent-substring-conflation-01", meta_file, linker_dir, eval_batch_size=200, 
