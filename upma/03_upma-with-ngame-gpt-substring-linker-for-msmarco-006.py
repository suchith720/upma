...
if __name__ == '__main__':
    ...
    output_dir = "/home/aiscuser/scratch1/outputs/upma/03_upma-with-ngame-gpt-substring-linker-for-msmarco-006"
    ...
    if input_args.beir_mode:
        meta_file = "/data/datasets/beir/msmarco/XC/substring/conflation_01/raw_data/substring.raw.csv"
        linker_dir = "/data/outputs/upma/00_msmarco-gpt-concept-substring-linker-with-ngame-loss-002/"
        upma_beir_inference(output_dir, input_args, mname, "msmarco-substring-conflation-01", meta_file, linker_dir, eval_batch_size=200, 
                            data_repr_pooling=False)
    else:
        config_file = (
            "configs/msmarco/substring/data_lbl_ngame-gpt-substring-conflation-01_ce-negatives-topk-05-linker_exact.json"
            if input_args.exact else
            "configs/msmarco/substring/data_lbl_ngame-gpt-substring-conflation-01.json"
        )
