...
if __name__ == '__main__':
    ...
    output_dir = "/data/suchith/outputs/upma/22_upma-with-ngame-gpt-intent-substring-linker-for-msmarco-with-calibration-loss-and-nvembed-teacher-001/"
    ...
    if input_args.beir_mode:
        ...
        upma_beir_inference(output_dir, input_args, mname, "msmarco-intent-substring-conflation-01", meta_file, linker_dir, eval_batch_size=600, 
                            ...
                            n_data_lnk_samples=3, data_lnk_topk=3, datasets=DATASETS)
    else:
        config_file = (
            "configs/msmarco/intent_substring/data_lbl_ngame-gpt-intent-substring-conflation-01_nvembed-thresh-90-topk-05-linker_exact.json"
