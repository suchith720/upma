...
if __name__ == '__main__':
    output_dir = "/data/suchith/outputs/upma/21_ngame-for-musique-with-reformated-query-003"
    ...
    config_file = "/home/sasokan/b-sprabhu/datasets/multihop/musique/XC/configs/data-reform.json"

    train_dset, test_dset = load_linker_block("musique", config_file, input_args, extra_args, main_max_data_sequence_length=512)
