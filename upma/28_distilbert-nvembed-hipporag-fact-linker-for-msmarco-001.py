...
if __name__ == '__main__':
    output_dir = "/data/suchith/outputs/upma/28_distilbert-nvembed-hipporag-fact-linker-for-msmarco-001"
    ...
    tst_ids = block.test.dset.data.data_info["identifier"]
    lbl_ids = block.test.dset.data.lbl_info["identifier"]
    
    assert tst_ids is not None
    assert lbl_ids is not None

    metric = BeirMetric(block.test.dset.n_lbl, k_values=[1, 3, 5, 10], qry_ids=tst_ids, lbl_ids=lbl_ids)
