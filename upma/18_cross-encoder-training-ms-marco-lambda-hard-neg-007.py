...
def main(do_inference=False):
    output_dir = "/data/suchith/outputs/upma/18_cross-encoder-training-ms-marco-lambda-hard-neg-007"
    pickle_dir = "/data/suchith/datasets/processed/"
