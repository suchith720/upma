...
if __name__ == '__main__':
    ...
    block = build_block(pkl_file, config_file, input_args.use_sxc_sampler, config_key, do_build=input_args.build_block, 
                        only_test=input_args.only_test, main_oversample=True, meta_oversample=False, return_scores=True, 
    ...
    def model_fn(mname:Optional[str]=None):
        ...
        model = UPA000.from_pretrained(config, mname=mname, meta_dset=meta_dset, batch_size=400)
        return model
