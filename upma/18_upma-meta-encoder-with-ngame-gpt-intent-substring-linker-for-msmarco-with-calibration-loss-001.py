...
if __name__ == '__main__':
    ...
    output_dir = "/home/aiscuser/scratch1/outputs/upma/18_upma-meta-encoder-with-ngame-gpt-intent-substring-linker-for-msmarco-with-calibration-loss-001"
    ...
    if input_args.beir_mode:
        ...
        upma_beir_inference(output_dir, input_args, mname, "msmarco-intent-substring-conflation-01", meta_file, linker_dir, eval_batch_size=400, 
                            ...
                            n_memory_layers=n_memory_layers, use_calib_loss=True, calib_loss_weight=0.1)
    else:
        config_file = (
