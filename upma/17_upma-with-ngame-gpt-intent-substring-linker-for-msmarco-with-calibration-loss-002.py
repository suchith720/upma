...
if __name__ == '__main__':
    ...
    output_dir = "/home/aiscuser/scratch1/outputs/upma/17_upma-with-ngame-gpt-intent-substring-linker-for-msmarco-with-calibration-loss-002"
    ...
    if input_args.beir_mode:
        ...
        upma_run(output_dir, input_args, mname, test_dset, train_dset, train_batch_size=128, data_repr_pooling=False, 
                 memory_injection_layer=memory_injection_layer, use_calib_loss=True, calib_loss_weight=0.01)
