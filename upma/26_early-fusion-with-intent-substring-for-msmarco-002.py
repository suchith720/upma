...
if __name__ == '__main__':
    ...
    output_dir = "/data/suchith/outputs/upma/26_early-fusion-with-intent-substring-for-msmarco-002"
    ...
    if input_args.beir_mode:
        ...
        config_file = "/data/datasets/beir/metadata/msmarco/configs/data-intent-substring_lbl_ce-negatives-topk-05-linker_exact.json"
